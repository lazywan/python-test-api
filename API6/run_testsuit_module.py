...
from API6.test_data import test_recharge#具体到模块
from API6.test_data import test_register#具体到模块
from API6.test_data import test_addloan#具体到模块
from API6.test_data import test_invest #具体到模块
...
suit.addTest(loader.loadTestsFromModule(test_addloan))
suit.addTest(loader.loadTestsFromModule(test_invest))
...
with open(project_path.report_path,'wb') as file: #使用html结尾的文件，打开方式是wb,如果是wb格式，不需要指定encoding编码
    ...
    #报错。AttributeError: 'str' object has no attribute '__name__'
